...
Mineradio 是一款 Windows 桌面音乐播放器，保留 Mineradio 原有的沉浸式界面、歌词舞台、粒子视觉、3D 歌单架和推荐入口，并新增“用户自导入 LX 音源”的播放解析层。

核心定位：网易云/QQ 负责推荐和歌单，LX 自定义源负责播放 URL 解析。
...
Mineradio 不是网易云音乐、QQ 音乐、LX Music 或任何音乐平台的官方客户端，也不隶属于上述平台。
